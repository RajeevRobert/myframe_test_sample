...
import com.test.pages.LoginPage;
	...
	/**
	 * Unit test for SearchProductTestScript.
	 */
	public class SearchProductTestScript extends BaseClass {

			/**
			 * Constuctor of SearchProductTestScript
			 */
			public SearchProductTestScript() {
				super();
			}
			...
			/**
			 * @Test testcase of searchProduct(TC_08)
			 */
			@Test
			public void searchProduct() {
				lp.searchProduct();
				try {
					BaseClass.takeSnapShot(driver,"searchProduct");
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
