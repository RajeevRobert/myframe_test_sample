...
import com.test.pages.LogoutPage;
	...
	public class VerifyLogoutTestScript  extends BaseClass {


		/**
		 * Constuctor of VerifyLogoutTestScript
		 */
		public VerifyLogoutTestScript() {
			super();
		}
		...
		/**
		 * @Test testcase of logout(TC_17)
		 */
		@Test
		public void   verifyLogout() {
			lp.logout();
			try {
				BaseClass.takeSnapShot(driver,"VerifyLogout");
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
